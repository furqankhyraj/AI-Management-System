...
SECRET_KEY = 'django-insecure-776r=z#j)%5srmp%y3g)y-yl_lhin=ftx743w1idvhz1$kypzx'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'Douzeroot$',
        'HOST': 'localhost',  # Use 'localhost' or the database server's IP address
